...
unsigned long channelInterval = 200;
...
void loop() {
    ...
    if (channelFlag[1]==1){
      ...
      {
        singleActuator(1);
        drv[1].setRealtimeValue(127);
      }
      else{
        singleActuator(1);
        drv[1].setRealtimeValue(0);
        disablesingle(1);
        drv[1].stop();
        channelFlag[1]==0;
      }
    ...
    if (channelFlag[3]==1){
      ...
      {
        singleActuator(3);
        drv[3].setRealtimeValue(127);
      }
      else{
        singleActuator(3);
        drv[3].setRealtimeValue(0);
        disablesingle(3);
        drv[3].stop();
        channelFlag[3]==0;
        }
